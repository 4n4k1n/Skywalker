...
int test_strnstr(void)
{
   ...
   res = single_test_strnstr(30, "hello world", "world", 11) && res;
   res = single_test_strnstr(31, "needle in haystack", "needle", 6) && res;
   res = single_test_strnstr(32, "test\0hidden", "hidden", 10) && res;
   res = single_test_strnstr(33, "partial match", "match", 7) && res;
   res = single_test_strnstr(34, "overlapping", "lap", 12) && res;
   res = single_test_strnstr(35, "multiple matches", "e", 16) && res;
   res = single_test_strnstr(36, "special\nchars", "\n", 8) && res;
   res = single_test_strnstr(37, "case sensitive", "CASE", 14) && res;
   res = single_test_strnstr(38, "boundary", "ary", 8) && res;
   res = single_test_strnstr(39, "exactly", "ly", 7) && res;
